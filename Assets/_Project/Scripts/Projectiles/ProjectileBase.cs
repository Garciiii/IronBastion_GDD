...
public class ProjectileBase : MonoBehaviour
{
    ...
    /// <summary>
    /// Override in subclasses to fire a different VFXType.
    /// Default spawns VFXType.ImpactBasic.
    /// </summary>
    protected virtual void SpawnImpactVFX(Vector3 position)
        => VFXManager.Spawn(VFXType.ImpactBasic, position);
