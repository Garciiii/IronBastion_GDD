...
public class CameraController : MonoBehaviour
{
    ...
    private Vector2 panLimitX = new(-5f, 35f);

    [SerializeField]
    [Tooltip("Limites de pan no eixo Z world (min, max).")]
    private Vector2 panLimitZ = new(-5f, 25f);
    ...
    private void HandleMousePan()
    {
        ...
        Vector3 pan = new(-deltaX, 0f, -deltaZ) * mouseSensitivity;
        ApplyPan(pan);
    }
    ...
    private void HandleKeyboardPan()
    {
        ...
        Vector3 pan = new(h, 0f, v) * keyboardMultiplier;
        ApplyPan(pan);
    }
